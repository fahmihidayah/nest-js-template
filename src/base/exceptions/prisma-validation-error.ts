import {
  ...
  export class PrismaClientValidationError extends BaseExceptionFilter {
     ...
     */
      ...
      exception: Prisma.PrismaClientKnownRequestError | Prisma.PrismaClientValidationError | any,
      host: ArgumentsHost,
    ) {
    ...
    private catchClientValidationError(
      ...
      super.catch(new HttpException({ statusCode, message : this.exceptionSummaryMessage(message) }, statusCode), host);
    }
